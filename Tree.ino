...
void loop() {
  ...
  if(digitalRead(wordButtonPin) == HIGH){
    if(previousWordState == false){
      decoded += interpret(code);     //The call for interpretation
      code = "";
      lcd.setCursor(0,0);
      lcd.print("                   ");
      lcd.setCursor(0,1);
...
String interpret(String code){
  ...
  if(code.charAt(0) == '.' && length > 1){//.cont
    if(code.charAt(1) == '.' && length > 2){//..cont
      if(code.charAt(2) == '.' && length > 3){//...cont
        if(code.charAt(3) == '.'){
          return "H";//....
        }
        return "V";//..._
      }
      else if(code.charAt(2) == '_' && length > 3){//.._cont
        if(code.charAt(3) == '.'){
          return "F";//.._.
        }
      }
    ...
    else if(code.charAt(1) == '_' && length > 2){//._cont
      if(code.charAt(2) == '.' && length > 3){//._.cont
        if(code.charAt(3) == '.'){
          return "L";//._..
        }
      }
      else if(code.charAt(2) == '_' && length > 3){//.__cont
        if(code.charAt(3) == '.'){
          return "P";//.__.
        }
        return "J";//.___
  ...
  else if(code.charAt(0) == '_' && length > 1){//_cont
    if(code.charAt(1) == '.' && length > 2){//_.cont
      if(code.charAt(2) == '.' && length > 3){//_..cont
        if(code.charAt(3) == '.'){
          return "B";//_...
        }
      ...
      else if(code.charAt(2) == '_' && length > 3){//_._cont
        if(code.charAt(3) == '.'){
          return "C";//_._.
        }
        return "Y";//_.__
    ...
    else if(code.charAt(1) == '_' && length > 2){//__cont
      if(code.charAt(2) == '.' && length > 3){//__.cont
        if(code.charAt(3) == '.'){
          return "Z";//__..
        }
        return "Q";//__._
